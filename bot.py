...
def baner():
    ...
    print(f"""
        ...
        {p}{b}╚  ╚═╝ {purple} ┴─┘┴┴ ┴└─┘└  └─┘┴─┘
{red}-----------------------------------------------
{cyan}Author   :{white}Nisa-XD
{cyan}Facebook :{white}https://facebook.com/100063843247862
{cyan}Github   :{white}https://github.com/Nisa-XD
{cyan}Wa       :{white}6281329562019
{red}-----------------------------------------------""")
...
def login():
    ...
    if "Login success!" in req:
       ...
       try:
           ...
           text=["Hi Nisa-XD tools nya keren banget!","tools nya sangat berguna!","Hi i'm user tools Ainx-BOT","semoga rejeki bang fahmi di lancarin amin","tools yang sangat bagus!"]
...
def like(url):
    ...
    if "Data loaded success!" in req:
        ...
        menu()
def userinfo():
    print(f"{c}Login as :{white}{name}")
    print(f"{c}ID       :{white}{id}")
    print(f"{red}-----------------------------------------------{d}")
####################menu######################
def menu():
    baner()
    userinfo()
    print(f"""{p}
{c}01{ab}. {yellow}earn credit
{c}02{ab}. {yellow}add like post
{c}03{ab}. {yellow}add followers
{c}00{ab}. {red}exit
{red}-----------------------------------------------{d}""")
    pilih_menu()
def pilih_menu():
    ...
    if choice == "00" or choice == "0":
       baner()
       sys.exit(f"{red}By bro jangan lupa kasih bintang github saya:)")
